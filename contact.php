...
if(isset($_POST["send"])) {
	...
	$pdo_statement = $con->prepare( $sql );	
	$result = $pdo_statement->execute( array( ':Message'=>$_POST['Message'],':Name'=>$_POST['Name'],':Email'=>$_POST['Email'],':Subject'=>$_POST['Subject']) );
	if (!empty($result) ){
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-1">
                        <div class="logo" id="div_branding">
                            <a href="index.html"><img src="assets/img/logo/osf_logo.png" alt=""></a>
                        </div>
                    </div>
                        ...
                        <div class="col-xl-7 col-lg-8 col-md-10 ">
                         <div class="hero-wrapper">
                            <div class="hero__caption">
                                <h1 data-animation="fadeInUp" data-delay=".3s" style="color:#3498db ">Contacts</h1>
                                <p data-animation="fadeInUp" data-delay=".6s">Where we are...<br> Bintkhamis </p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-8">
                    <div class="single-cat text-center mb-30">
                        <div class="cat-icon">
                            <img src="assets/img/gallery/i.png" height="160"width="160"alt="">
                        </div>
                        <div class="cat-cap">
				...
				<div class="col-lg-3 col-md-6 col-sm-8">
                    <div class="single-cat text-center mb-30">
                        <div class="cat-icon">
                            <img src="assets/img/gallery/k.png" height="160"width="160"alt="">
                        </div>
                        <div class="cat-cap">
                            <h5><a href="#">GIS & Drone Expert</a></h5>
                           <p> Ms Khadija Abdulla</p>
							<p> Mentor</p>
						   <p> +255 773 379 598</p>
                        </div>
                    </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-8">
                    <div class="single-cat text-center mb-30">
                        <div class="cat-icon">
                            <img src="assets/img/gallery/w.png"height="160"width="160" alt="">
                        </div>
                        <div class="cat-cap">
                            <h5><a href="#">Director</a></h5>
                           <p> Mr William Evan</p>
                ...
                <div class="col-lg-3 col-md-6 col-sm-8">
                    <div class="single-cat text-center mb-30">
                        <div class="cat-icon">
                            <img src="assets/img/gallery/m.png"height="160"width="160" alt="">
                        </div>
                        <div class="cat-cap">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 offset-lg-1">
                ...
                <div class="media contact-info">
                    ...
                    <div class="media-body">
                        <h3>bintkhamis1819@gmail.com</h3>
